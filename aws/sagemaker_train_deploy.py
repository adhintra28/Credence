...
# SAGEMAKER_ROLE = "arn:aws:iam::873072308783:role/service-role/AmazonSageMaker-ExecutionRole-XXXXXXXX"
...
# Replace the bucket name below
# est.fit({
#     "train": "s3://predelinquency-data/processed/"
# })
